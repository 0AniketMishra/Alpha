...
const Grid = () => {
    ...
    const items = [
        { id: 1, title: "Glock 19: Semi-automatic pistol with preinstalled suppresor", image: 'https://nationalinterest.org/sites/default/files/main_images/U78%20(1).jpg', price: "$400", reviews: 5, sellerName: 'The Smuglers', sellerId: 'None', description: dummy },
        { id: 2, title: "Glock 19: Semi-automatic pistol with preinstalled suppresor", image: 'https://allmywebneeds.com/wp-content/uploads/2020/01/how-to-prevent-hackers.jpeg', price: "$240", reviews: 5, sellerName: 'The Hackers', sellerId: 'None', description: "Account based hacking services. Google,Facebook,Instagram etc(Only Username Required)" },
