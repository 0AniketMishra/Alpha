              ...
              <div className="container px-5 py-10 mx-auto" bis_skin_checked="1">
                  <div className=" mb-10" bis_skin_checked="1">
                    <div className='flex items-center mb-2'>
                          ...
                          <h1 className="sm:text-3xl text-2xl font-medium  title-font text-indigo-500 ml-2">  The Cartel</h1>
                    </div>
                      <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 text-white">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo juice poutine, ramps microdosing banh mi pug.</p>
                  </div>
                  <div className="flex flex-wrap lg:w-4/5  sm:mb-2 -mx-2" bis_skin_checked="1">
                      <div className="p-2 sm:w-1/2 w-full" bis_skin_checked="1">
                          <div className="bg-gray-900 rounded flex p-4 h-full items-center" bis_skin_checked="1">
