                            ...
                            <div className="py-8 flex flex-wrap md:flex-nowrap" bis_skin_checked="1">
                                <div className="md:w-1/6 md:mb-0  flex-shrink-0 flex flex-col" bis_skin_checked="1">
                                     <div className='flex items-center'>
                                        <h1 className="font-semibold  text-xl text-gray-200">First Middle Surname</h1>
                               ...
                               <div className=''>
                                    <div className="md:flex-grow mb-4" bis_skin_checked="1">
                                        <h2 className="text-xl font-medium text-white title-font mb-2">Very Nice Product .</h2>
