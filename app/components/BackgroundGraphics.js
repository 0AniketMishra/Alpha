...
export function BackgroundGraphics() {
    return (
        <div className="absolute inset-0 overflow-hidden pointer-events-none ">
            ...
            <div className="absolute -top-20 -left-20 w-[500px] h-[300px] rounded-full bg-gradient-to-r from-blue-400/10 to-cyan-400/10 dark:from-blue-400/5 dark:to-cyan-400/5 blur-2xl animate-pulse delay-700" />
