  ...
  return (
      <div className="relative hidden lg:flex xl:flex 2xl:flex  flex-col bg-clip-border  bg-transparent text-gray-700  w-[60%] max-w-[14rem] pr-0 pl-2 pt-2 pb-2 shadow-xl shadow-blue-gray-900/5">
          ...
          <nav className="flex flex-col gap-1 min-w-[240px] p-2 font-sans text-base font-normal text-white">
              <div role="button" tabindex="0" className="flex items-center w-[80%] p-3 rounded-lg text-start leading-tight transition-all hover:bg-blue-50 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-gray-50 active:bg-opacity-80 hover:text-blue-900 focus:text-blue-900 active:text-blue-900 outline-none">
              ...
              <div role="button" tabindex="0" className="flex items-center w-[80%] p-3 rounded-lg text-start leading-tight transition-all hover:bg-blue-50 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-blue-50 active:bg-opacity-80 hover:text-blue-900 focus:text-blue-900 active:text-blue-900 outline-none">
                  <div className="grid place-items-center mr-4">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="h-5 w-5">
