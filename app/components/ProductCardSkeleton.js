  ...
  return (
    <div className="group relative bg-white dark:bg-def rounded-xl shadow-lg transition-all hover:shadow-xl">
        ...
        <div className="aspect-16/10 w-full overflow-hidden rounded-t-xl bg-gray-200">
          <div
            className="h-full w-full object-cover object-center group-hover:opacity-75 transition-opacity bg-gray-600 "
          />
        ...
        <div className="mt-4 p-4">
          <div className="space-y-2 animate-pulse">
            <div className="text-lg font-medium h-5 rounded-full dark:bg-gray-600 w-full line-clamp-1"></div>
          <div className="text-lg font-medium h-5 rounded-full dark:bg-gray-600 w-full line-clamp-1"></div>
          </div>
          <div className="mt-2  h-3 w-[80%] mt-4 rounded-full dark:bg-gray-600 animate-pulse"></div>
        <div className="mt-2  h-3 w-[80%] mt-4 rounded-full dark:bg-gray-600 animate-pulse"></div>

          <div className="flex mt-2 items-center space-x-2">
            
              <div className="text-md rounded-full dark:bg-gray-600 h-4 w-16"></div>
          <div className="text-md rounded-full dark:bg-gray-600 h-4 w-16 animate-pulse"></div>
      ...
      <div className="pl-4 pr-4 pb-4 space-y-3">
        ...
        <button className="w-full dark:bg-orange-600  py-2 rounded-xl transition-colors ">
          Add to Cart
        </button>
      </div>
    </div>
